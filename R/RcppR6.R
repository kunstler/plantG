...
## Version: 0.2.4
## Hash: 6c9fa3b060652e63f4fa800bb87d368e
...
Plant <- function(T) {
  type <- c(T)
  valid <- list("Plant<FF16>"="FF16", "Plant<FF16r>"="FF16r", "Plant<FF16FvCB>"="FF16FvCB")
  constructors <- list("Plant<FF16>"=`Plant<FF16>`, "Plant<FF16r>"=`Plant<FF16r>`, "Plant<FF16FvCB>"=`Plant<FF16FvCB>`)
  constructors[[check_type(type, valid)]]
}
...
`Plant<FF16FvCB>` <- function(s) {
  Plant___FF16FvCB__ctor(s)
}
.R6_Plant___FF16FvCB <-
  R6::R6Class(
    "Plant<FF16FvCB>",
    ...
    public=list(
      ...
      area_leaf_above = function(h) {
        Plant___FF16FvCB__area_leaf_above(self, h)
      },
      compute_vars_phys = function(environment) {
        Plant___FF16FvCB__compute_vars_phys(self, environment)
      },
      germination_probability = function(environment) {
        Plant___FF16FvCB__germination_probability(self, environment)
      },
      reset_mortality = function() {
        Plant___FF16FvCB__reset_mortality(self)
      }),
    active=list(
      height = function(value) {
        if (missing(value)) {
          Plant___FF16FvCB__height__get(self)
        } else {
          Plant___FF16FvCB__height__set(self, value)
        }
      },
      mortality = function(value) {
        if (missing(value)) {
          Plant___FF16FvCB__mortality__get(self)
        } else {
          Plant___FF16FvCB__mortality__set(self, value)
        }
      },
      fecundity = function(value) {
        if (missing(value)) {
          Plant___FF16FvCB__fecundity__get(self)
        } else {
          Plant___FF16FvCB__fecundity__set(self, value)
        }
      },
      strategy = function(value) {
        if (missing(value)) {
          Plant___FF16FvCB__strategy__get(self)
        } else {
          stop("Plant<FF16FvCB>$strategy is read-only")
        }
      },
      internals = function(value) {
        if (missing(value)) {
          Plant___FF16FvCB__internals__get(self)
        } else {
          stop("Plant<FF16FvCB>$internals is read-only")
        }
      },
      ode_size = function(value) {
        if (missing(value)) {
          Plant___FF16FvCB__ode_size__get(self)
        } else {
          stop("Plant<FF16FvCB>$ode_size is read-only")
        }
      },
      ode_state = function(value) {
        if (missing(value)) {
          Plant___FF16FvCB__ode_state__get(self)
        } else {
          Plant___FF16FvCB__ode_state__set(self, value)
        }
      },
      ode_rates = function(value) {
        if (missing(value)) {
          Plant___FF16FvCB__ode_rates__get(self)
        } else {
          stop("Plant<FF16FvCB>$ode_rates is read-only")
        }
      },
      ode_names = function(value) {
        if (missing(value)) {
          Plant___FF16FvCB__ode_names__get(self)
        } else {
          stop("Plant<FF16FvCB>$ode_names is read-only")
        }
      },
      mortality_probability = function(value) {
        if (missing(value)) {
          Plant___FF16FvCB__mortality_probability__get(self)
        } else {
          stop("Plant<FF16FvCB>$mortality_probability is read-only")
        }
      }))
...
##' variadic arguments, or as a list, but not both).
##' @export
`FF16FvCB_Strategy` <- function(..., values=list(...)) {
  ret <- FF16FvCB_Strategy__ctor()
  if (length(values) > 0L) {
    if (is.null(names(values)) || any(names(values) == "")) {
      stop("All values must be named")
    }
...
Parameters <- function(T) {
  type <- c(T)
  valid <- list("Parameters<FF16>"="FF16", "Parameters<FF16r>"="FF16r", "Parameters<FF16FvCB>"="FF16FvCB")
  constructors <- list("Parameters<FF16>"=`Parameters<FF16>`, "Parameters<FF16r>"=`Parameters<FF16r>`, "Parameters<FF16FvCB>"=`Parameters<FF16FvCB>`)
  constructors[[check_type(type, valid)]]
}
...
`Parameters<FF16FvCB>` <- function(..., values=list(...)) {
  ret <- Parameters___FF16FvCB__ctor()
  if (length(values) > 0L) {
    if (is.null(names(values)) || any(names(values) == "")) {
      stop("All values must be named")
    }
  ...
  Parameters___FF16FvCB__vdor(ret)
}
...
PlantPlus <- function(T) {
  type <- c(T)
  valid <- list("PlantPlus<FF16>"="FF16", "PlantPlus<FF16r>"="FF16r", "PlantPlus<FF16FvCB>"="FF16FvCB")
  constructors <- list("PlantPlus<FF16>"=`PlantPlus<FF16>`, "PlantPlus<FF16r>"=`PlantPlus<FF16r>`, "PlantPlus<FF16FvCB>"=`PlantPlus<FF16FvCB>`)
  constructors[[check_type(type, valid)]]
}
...
`PlantPlus<FF16FvCB>` <- function(strategy) {
  PlantPlus___FF16FvCB__ctor(strategy)
}
.R6_PlantPlus___FF16FvCB <-
  R6::R6Class(
    "PlantPlus<FF16FvCB>",
    inherit=.R6_PlantPlus,
    portable=TRUE,
    public=list(
      ...
      area_leaf_above = function(h) {
        PlantPlus___FF16FvCB__area_leaf_above(self, h)
      },
      compute_vars_phys = function(environment) {
        PlantPlus___FF16FvCB__compute_vars_phys(self, environment)
      },
      compute_vars_growth = function() {
        PlantPlus___FF16FvCB__compute_vars_growth(self)
      },
      germination_probability = function(environment) {
        PlantPlus___FF16FvCB__germination_probability(self, environment)
      },
      to_plant = function() {
        PlantPlus___FF16FvCB__to_plant(self)
      }),
    active=list(
      height = function(value) {
        if (missing(value)) {
          PlantPlus___FF16FvCB__height__get(self)
        } else {
          PlantPlus___FF16FvCB__height__set(self, value)
        }
      },
      mortality = function(value) {
        if (missing(value)) {
          PlantPlus___FF16FvCB__mortality__get(self)
        } else {
          PlantPlus___FF16FvCB__mortality__set(self, value)
        }
      },
      fecundity = function(value) {
        if (missing(value)) {
          PlantPlus___FF16FvCB__fecundity__get(self)
        } else {
          PlantPlus___FF16FvCB__fecundity__set(self, value)
        }
      },
      area_heartwood = function(value) {
        if (missing(value)) {
          PlantPlus___FF16FvCB__area_heartwood__get(self)
        } else {
          PlantPlus___FF16FvCB__area_heartwood__set(self, value)
        }
      },
      mass_heartwood = function(value) {
        if (missing(value)) {
          PlantPlus___FF16FvCB__mass_heartwood__get(self)
        } else {
          PlantPlus___FF16FvCB__mass_heartwood__set(self, value)
        }
      },
      area_leaf = function(value) {
        if (missing(value)) {
          PlantPlus___FF16FvCB__area_leaf__get(self)
        } else {
          stop("PlantPlus<FF16FvCB>$area_leaf is read-only")
        }
      },
      strategy = function(value) {
        if (missing(value)) {
          PlantPlus___FF16FvCB__strategy__get(self)
        } else {
          stop("PlantPlus<FF16FvCB>$strategy is read-only")
        }
      },
      internals = function(value) {
        if (missing(value)) {
          PlantPlus___FF16FvCB__internals__get(self)
        } else {
          stop("PlantPlus<FF16FvCB>$internals is read-only")
        }
      },
      ode_size = function(value) {
        if (missing(value)) {
          PlantPlus___FF16FvCB__ode_size__get(self)
        } else {
          stop("PlantPlus<FF16FvCB>$ode_size is read-only")
        }
      },
      ode_state = function(value) {
        if (missing(value)) {
          PlantPlus___FF16FvCB__ode_state__get(self)
        } else {
          PlantPlus___FF16FvCB__ode_state__set(self, value)
        }
      },
      ode_rates = function(value) {
        if (missing(value)) {
          PlantPlus___FF16FvCB__ode_rates__get(self)
        } else {
          stop("PlantPlus<FF16FvCB>$ode_rates is read-only")
        }
      },
      ode_names = function(value) {
        if (missing(value)) {
          PlantPlus___FF16FvCB__ode_names__get(self)
        } else {
          stop("PlantPlus<FF16FvCB>$ode_names is read-only")
        }
      }))
...
Cohort <- function(T) {
  type <- c(T)
  valid <- list("Cohort<FF16>"="FF16", "Cohort<FF16r>"="FF16r", "Cohort<FF16FvCB>"="FF16FvCB")
  constructors <- list("Cohort<FF16>"=`Cohort<FF16>`, "Cohort<FF16r>"=`Cohort<FF16r>`, "Cohort<FF16FvCB>"=`Cohort<FF16FvCB>`)
  constructors[[check_type(type, valid)]]
}
...
`Cohort<FF16FvCB>` <- function(strategy) {
  Cohort___FF16FvCB__ctor(strategy)
}
.R6_Cohort___FF16FvCB <-
  R6::R6Class(
    "Cohort<FF16FvCB>",
    inherit=.R6_Cohort,
    portable=TRUE,
    public=list(
      ...
      area_leaf_above = function(height) {
        Cohort___FF16FvCB__area_leaf_above(self, height)
      },
      growth_rate_gradient = function(environment) {
        Cohort___FF16FvCB__growth_rate_gradient(self, environment)
      },
      compute_vars_phys = function(environment) {
        Cohort___FF16FvCB__compute_vars_phys(self, environment)
      },
      compute_initial_conditions = function(environment) {
        Cohort___FF16FvCB__compute_initial_conditions(self, environment)
      }),
    active=list(
      plant = function(value) {
        if (missing(value)) {
          Cohort___FF16FvCB__plant__get(self)
        } else {
          stop("Cohort<FF16FvCB>$plant is read-only")
        }
      },
      height = function(value) {
        if (missing(value)) {
          Cohort___FF16FvCB__height__get(self)
        } else {
          stop("Cohort<FF16FvCB>$height is read-only")
        }
      },
      log_density = function(value) {
        if (missing(value)) {
          Cohort___FF16FvCB__log_density__get(self)
        } else {
          stop("Cohort<FF16FvCB>$log_density is read-only")
        }
      },
      area_leaf = function(value) {
        if (missing(value)) {
          Cohort___FF16FvCB__area_leaf__get(self)
        } else {
          stop("Cohort<FF16FvCB>$area_leaf is read-only")
        }
      },
      fecundity = function(value) {
        if (missing(value)) {
          Cohort___FF16FvCB__fecundity__get(self)
        } else {
          stop("Cohort<FF16FvCB>$fecundity is read-only")
        }
      },
      ode_size = function(value) {
        if (missing(value)) {
          Cohort___FF16FvCB__ode_size__get(self)
        } else {
          stop("Cohort<FF16FvCB>$ode_size is read-only")
        }
      },
      ode_state = function(value) {
        if (missing(value)) {
          Cohort___FF16FvCB__ode_state__get(self)
        } else {
          Cohort___FF16FvCB__ode_state__set(self, value)
        }
      },
      ode_rates = function(value) {
        if (missing(value)) {
          Cohort___FF16FvCB__ode_rates__get(self)
        } else {
          stop("Cohort<FF16FvCB>$ode_rates is read-only")
        }
      },
      ode_names = function(value) {
        if (missing(value)) {
          Cohort___FF16FvCB__ode_names__get(self)
        } else {
          stop("Cohort<FF16FvCB>$ode_names is read-only")
        }
      }))

Species <- function(T) {
  type <- c(T)
  valid <- list("Species<FF16>"="FF16", "Species<FF16r>"="FF16r", "Species<FF16FvCB>"="FF16FvCB")
  constructors <- list("Species<FF16>"=`Species<FF16>`, "Species<FF16r>"=`Species<FF16r>`, "Species<FF16FvCB>"=`Species<FF16FvCB>`)
  constructors[[check_type(type, valid)]]
}
...
`Species<FF16FvCB>` <- function(strategy) {
  Species___FF16FvCB__ctor(strategy)
}
.R6_Species___FF16FvCB <-
  R6::R6Class(
    "Species<FF16FvCB>",
    inherit=.R6_Species,
    portable=TRUE,
    public=list(
      ...
      clear = function() {
        Species___FF16FvCB__clear(self)
      },
      compute_vars_phys = function(environment) {
        Species___FF16FvCB__compute_vars_phys(self, environment)
      },
      area_leaf_above = function(height) {
        Species___FF16FvCB__area_leaf_above(self, height)
      },
      add_seed = function() {
        Species___FF16FvCB__add_seed(self)
      },
      cohort_at = function(index) {
        Species___FF16FvCB__cohort_at(self, index)
      },
      area_leafs_error = function(scal=1) {
        Species___FF16FvCB__area_leafs_error(self, scal)
      }),
    active=list(
      size = function(value) {
        if (missing(value)) {
          Species___FF16FvCB__size__get(self)
        } else {
          stop("Species<FF16FvCB>$size is read-only")
        }
      },
      seed = function(value) {
        if (missing(value)) {
          Species___FF16FvCB__seed__get(self)
        } else {
          stop("Species<FF16FvCB>$seed is read-only")
        }
      },
      height_max = function(value) {
        if (missing(value)) {
          Species___FF16FvCB__height_max__get(self)
        } else {
          stop("Species<FF16FvCB>$height_max is read-only")
        }
      },
      heights = function(value) {
        if (missing(value)) {
          Species___FF16FvCB__heights__get(self)
        } else {
          Species___FF16FvCB__heights__set(self, value)
        }
      },
      log_densities = function(value) {
        if (missing(value)) {
          Species___FF16FvCB__log_densities__get(self)
        } else {
          stop("Species<FF16FvCB>$log_densities is read-only")
        }
      },
      cohorts = function(value) {
        if (missing(value)) {
          Species___FF16FvCB__cohorts__get(self)
        } else {
          stop("Species<FF16FvCB>$cohorts is read-only")
        }
      },
      seeds = function(value) {
        if (missing(value)) {
          Species___FF16FvCB__seeds__get(self)
        } else {
          stop("Species<FF16FvCB>$seeds is read-only")
        }
      },
      area_leafs = function(value) {
        if (missing(value)) {
          Species___FF16FvCB__area_leafs__get(self)
        } else {
          stop("Species<FF16FvCB>$area_leafs is read-only")
        }
      },
      ode_size = function(value) {
        if (missing(value)) {
          Species___FF16FvCB__ode_size__get(self)
        } else {
          stop("Species<FF16FvCB>$ode_size is read-only")
        }
      },
      ode_state = function(value) {
        if (missing(value)) {
          Species___FF16FvCB__ode_state__get(self)
        } else {
          Species___FF16FvCB__ode_state__set(self, value)
        }
      },
      ode_rates = function(value) {
        if (missing(value)) {
          Species___FF16FvCB__ode_rates__get(self)
        } else {
          stop("Species<FF16FvCB>$ode_rates is read-only")
        }
      }))

Patch <- function(T) {
  type <- c(T)
  valid <- list("Patch<FF16>"="FF16", "Patch<FF16r>"="FF16r", "Patch<FF16FvCB>"="FF16FvCB")
  constructors <- list("Patch<FF16>"=`Patch<FF16>`, "Patch<FF16r>"=`Patch<FF16r>`, "Patch<FF16FvCB>"=`Patch<FF16FvCB>`)
  constructors[[check_type(type, valid)]]
}
...
`Patch<FF16FvCB>` <- function(parameters) {
  Patch___FF16FvCB__ctor(parameters)
}
.R6_Patch___FF16FvCB <-
  R6::R6Class(
    "Patch<FF16FvCB>",
    ...
    public=list(
      ...
      area_leaf_above = function(height) {
        Patch___FF16FvCB__area_leaf_above(self, height)
      },
      canopy_openness = function(height) {
        Patch___FF16FvCB__canopy_openness(self, height)
      },
      add_seed = function(species_index) {
        Patch___FF16FvCB__add_seed(self, species_index)
      },
      compute_light_environment = function() {
        Patch___FF16FvCB__compute_light_environment(self)
      },
      compute_vars_phys = function() {
        Patch___FF16FvCB__compute_vars_phys(self)
      },
      reset = function() {
        Patch___FF16FvCB__reset(self)
      },
      set_ode_state = function(values, time) {
        Patch___FF16FvCB__set_ode_state(self, values, time)
      },
      derivs = function(y, time) {
        Patch___FF16FvCB__derivs(self, y, time)
      },
      set_state = function(time, state, n, light_env) {
        Patch___FF16FvCB__set_state(self, time, state, n, light_env)
      }),
    active=list(
      time = function(value) {
        if (missing(value)) {
          Patch___FF16FvCB__time__get(self)
        } else {
          stop("Patch<FF16FvCB>$time is read-only")
        }
      },
      size = function(value) {
        if (missing(value)) {
          Patch___FF16FvCB__size__get(self)
        } else {
          stop("Patch<FF16FvCB>$size is read-only")
        }
      },
      height_max = function(value) {
        if (missing(value)) {
          Patch___FF16FvCB__height_max__get(self)
        } else {
          stop("Patch<FF16FvCB>$height_max is read-only")
        }
      },
      parameters = function(value) {
        if (missing(value)) {
          Patch___FF16FvCB__parameters__get(self)
        } else {
          stop("Patch<FF16FvCB>$parameters is read-only")
        }
      },
      environment = function(value) {
        if (missing(value)) {
          Patch___FF16FvCB__environment__get(self)
        } else {
          stop("Patch<FF16FvCB>$environment is read-only")
        }
      },
      species = function(value) {
        if (missing(value)) {
          Patch___FF16FvCB__species__get(self)
        } else {
          stop("Patch<FF16FvCB>$species is read-only")
        }
      },
      ode_size = function(value) {
        if (missing(value)) {
          Patch___FF16FvCB__ode_size__get(self)
        } else {
          stop("Patch<FF16FvCB>$ode_size is read-only")
        }
      },
      ode_time = function(value) {
        if (missing(value)) {
          Patch___FF16FvCB__ode_time__get(self)
        } else {
          stop("Patch<FF16FvCB>$ode_time is read-only")
        }
      },
      ode_state = function(value) {
        if (missing(value)) {
          Patch___FF16FvCB__ode_state__get(self)
        } else {
          stop("Patch<FF16FvCB>$ode_state is read-only")
        }
      },
      ode_rates = function(value) {
        if (missing(value)) {
          Patch___FF16FvCB__ode_rates__get(self)
        } else {
          stop("Patch<FF16FvCB>$ode_rates is read-only")
        }
      }))

SCM <- function(T) {
  type <- c(T)
  valid <- list("SCM<FF16>"="FF16", "SCM<FF16r>"="FF16r", "SCM<FF16FvCB>"="FF16FvCB")
  constructors <- list("SCM<FF16>"=`SCM<FF16>`, "SCM<FF16r>"=`SCM<FF16r>`, "SCM<FF16FvCB>"=`SCM<FF16FvCB>`)
  constructors[[check_type(type, valid)]]
}
...
`SCM<FF16FvCB>` <- function(parameters) {
  SCM___FF16FvCB__ctor(parameters)
}
.R6_SCM___FF16FvCB <-
  R6::R6Class(
    "SCM<FF16FvCB>",
    ...
    public=list(
      ...
      run = function() {
        SCM___FF16FvCB__run(self)
      },
      run_next = function() {
        SCM___FF16FvCB__run_next(self)
      },
      reset = function() {
        SCM___FF16FvCB__reset(self)
      },
      seed_rain = function(species_index) {
        SCM___FF16FvCB__seed_rain(self, species_index)
      },
      seed_rain_cohort = function(species_index) {
        SCM___FF16FvCB__seed_rain_cohort(self, species_index)
      },
      area_leaf_error = function(species_index) {
        SCM___FF16FvCB__area_leaf_error(self, species_index)
      },
      set_cohort_schedule_times = function(times) {
        SCM___FF16FvCB__set_cohort_schedule_times(self, times)
      }),
    active=list(
      complete = function(value) {
        if (missing(value)) {
          SCM___FF16FvCB__complete__get(self)
        } else {
          stop("SCM<FF16FvCB>$complete is read-only")
        }
      },
      time = function(value) {
        if (missing(value)) {
          SCM___FF16FvCB__time__get(self)
        } else {
          stop("SCM<FF16FvCB>$time is read-only")
        }
      },
      seed_rains = function(value) {
        if (missing(value)) {
          SCM___FF16FvCB__seed_rains__get(self)
        } else {
          stop("SCM<FF16FvCB>$seed_rains is read-only")
        }
      },
      parameters = function(value) {
        if (missing(value)) {
          SCM___FF16FvCB__parameters__get(self)
        } else {
          stop("SCM<FF16FvCB>$parameters is read-only")
        }
      },
      patch = function(value) {
        if (missing(value)) {
          SCM___FF16FvCB__patch__get(self)
        } else {
          stop("SCM<FF16FvCB>$patch is read-only")
        }
      },
      cohort_schedule = function(value) {
        if (missing(value)) {
          SCM___FF16FvCB__cohort_schedule__get(self)
        } else {
          SCM___FF16FvCB__cohort_schedule__set(self, value)
        }
      },
      ode_times = function(value) {
        if (missing(value)) {
          SCM___FF16FvCB__ode_times__get(self)
        } else {
          stop("SCM<FF16FvCB>$ode_times is read-only")
        }
      },
      state = function(value) {
        if (missing(value)) {
          SCM___FF16FvCB__state__get(self)
        } else {
          stop("SCM<FF16FvCB>$state is read-only")
        }
      },
      use_ode_times = function(value) {
        if (missing(value)) {
          SCM___FF16FvCB__use_ode_times__get(self)
        } else {
          SCM___FF16FvCB__use_ode_times__set(self, value)
        }
      },
      seed_rain_error = function(value) {
        if (missing(value)) {
          SCM___FF16FvCB__seed_rain_error__get(self)
        } else {
          stop("SCM<FF16FvCB>$seed_rain_error is read-only")
        }
      }))

StochasticSpecies <- function(T) {
  type <- c(T)
  valid <- list("StochasticSpecies<FF16>"="FF16", "StochasticSpecies<FF16r>"="FF16r", "StochasticSpecies<FF16FvCB>"="FF16FvCB")
  constructors <- list("StochasticSpecies<FF16>"=`StochasticSpecies<FF16>`, "StochasticSpecies<FF16r>"=`StochasticSpecies<FF16r>`, "StochasticSpecies<FF16FvCB>"=`StochasticSpecies<FF16FvCB>`)
  constructors[[check_type(type, valid)]]
}
...
`StochasticSpecies<FF16FvCB>` <- function(strategy) {
  StochasticSpecies___FF16FvCB__ctor(strategy)
}
.R6_StochasticSpecies___FF16FvCB <-
  R6::R6Class(
    "StochasticSpecies<FF16FvCB>",
    inherit=.R6_StochasticSpecies,
    portable=TRUE,
    public=list(
      .ptr=NULL,
      ...
      clear = function() {
        StochasticSpecies___FF16FvCB__clear(self)
      },
      compute_vars_phys = function(environment) {
        StochasticSpecies___FF16FvCB__compute_vars_phys(self, environment)
      },
      area_leaf_above = function(height) {
        StochasticSpecies___FF16FvCB__area_leaf_above(self, height)
      },
      add_seed = function() {
        StochasticSpecies___FF16FvCB__add_seed(self)
      },
      plant_at = function(index) {
        StochasticSpecies___FF16FvCB__plant_at(self, index)
      },
      deaths = function() {
        StochasticSpecies___FF16FvCB__deaths(self)
      },
      germination_probability = function(environment) {
        StochasticSpecies___FF16FvCB__germination_probability(self, environment)
      }),
    active=list(
      size = function(value) {
        if (missing(value)) {
          StochasticSpecies___FF16FvCB__size__get(self)
        } else {
          stop("StochasticSpecies<FF16FvCB>$size is read-only")
        }
      },
      size_plants = function(value) {
        if (missing(value)) {
          StochasticSpecies___FF16FvCB__size_plants__get(self)
        } else {
          stop("StochasticSpecies<FF16FvCB>$size_plants is read-only")
        }
      },
      seed = function(value) {
        if (missing(value)) {
          StochasticSpecies___FF16FvCB__seed__get(self)
        } else {
          stop("StochasticSpecies<FF16FvCB>$seed is read-only")
        }
      },
      height_max = function(value) {
        if (missing(value)) {
          StochasticSpecies___FF16FvCB__height_max__get(self)
        } else {
          stop("StochasticSpecies<FF16FvCB>$height_max is read-only")
        }
      },
      heights = function(value) {
        if (missing(value)) {
          StochasticSpecies___FF16FvCB__heights__get(self)
        } else {
          StochasticSpecies___FF16FvCB__heights__set(self, value)
        }
      },
      plants = function(value) {
        if (missing(value)) {
          StochasticSpecies___FF16FvCB__plants__get(self)
        } else {
          stop("StochasticSpecies<FF16FvCB>$plants is read-only")
        }
      },
      is_alive = function(value) {
        if (missing(value)) {
          StochasticSpecies___FF16FvCB__is_alive__get(self)
        } else {
          stop("StochasticSpecies<FF16FvCB>$is_alive is read-only")
        }
      },
      seeds = function(value) {
        if (missing(value)) {
          StochasticSpecies___FF16FvCB__seeds__get(self)
        } else {
          stop("StochasticSpecies<FF16FvCB>$seeds is read-only")
        }
      },
      ode_size = function(value) {
        if (missing(value)) {
          StochasticSpecies___FF16FvCB__ode_size__get(self)
        } else {
          stop("StochasticSpecies<FF16FvCB>$ode_size is read-only")
        }
      },
      ode_state = function(value) {
        if (missing(value)) {
          StochasticSpecies___FF16FvCB__ode_state__get(self)
        } else {
          StochasticSpecies___FF16FvCB__ode_state__set(self, value)
        }
      },
      ode_rates = function(value) {
        if (missing(value)) {
          StochasticSpecies___FF16FvCB__ode_rates__get(self)
        } else {
          stop("StochasticSpecies<FF16FvCB>$ode_rates is read-only")
        }
      }))

StochasticPatch <- function(T) {
  type <- c(T)
  valid <- list("StochasticPatch<FF16>"="FF16", "StochasticPatch<FF16r>"="FF16r", "StochasticPatch<FF16FvCB>"="FF16FvCB")
  constructors <- list("StochasticPatch<FF16>"=`StochasticPatch<FF16>`, "StochasticPatch<FF16r>"=`StochasticPatch<FF16r>`, "StochasticPatch<FF16FvCB>"=`StochasticPatch<FF16FvCB>`)
  constructors[[check_type(type, valid)]]
}
...
`StochasticPatch<FF16FvCB>` <- function(parameters) {
  StochasticPatch___FF16FvCB__ctor(parameters)
}
.R6_StochasticPatch___FF16FvCB <-
  R6::R6Class(
    "StochasticPatch<FF16FvCB>",
    inherit=.R6_StochasticPatch,
    portable=TRUE,
    public=list(
      .ptr=NULL,
      ...
      area_leaf_above = function(height) {
        StochasticPatch___FF16FvCB__area_leaf_above(self, height)
      },
      canopy_openness = function(height) {
        StochasticPatch___FF16FvCB__canopy_openness(self, height)
      },
      add_seed = function(species_index) {
        StochasticPatch___FF16FvCB__add_seed(self, species_index)
      },
      add_seedling = function(species_index) {
        StochasticPatch___FF16FvCB__add_seedling(self, species_index)
      },
      compute_light_environment = function() {
        StochasticPatch___FF16FvCB__compute_light_environment(self)
      },
      compute_vars_phys = function() {
        StochasticPatch___FF16FvCB__compute_vars_phys(self)
      },
      reset = function() {
        StochasticPatch___FF16FvCB__reset(self)
      },
      set_ode_state = function(values, time) {
        StochasticPatch___FF16FvCB__set_ode_state(self, values, time)
      },
      derivs = function(y, time) {
        StochasticPatch___FF16FvCB__derivs(self, y, time)
      },
      set_state = function(time, state, n) {
        StochasticPatch___FF16FvCB__set_state(self, time, state, n)
      },
      deaths = function() {
        StochasticPatch___FF16FvCB__deaths(self)
      }),
    active=list(
      time = function(value) {
        if (missing(value)) {
          StochasticPatch___FF16FvCB__time__get(self)
        } else {
          stop("StochasticPatch<FF16FvCB>$time is read-only")
        }
      },
      size = function(value) {
        if (missing(value)) {
          StochasticPatch___FF16FvCB__size__get(self)
        } else {
          stop("StochasticPatch<FF16FvCB>$size is read-only")
        }
      },
      height_max = function(value) {
        if (missing(value)) {
          StochasticPatch___FF16FvCB__height_max__get(self)
        } else {
          stop("StochasticPatch<FF16FvCB>$height_max is read-only")
        }
      },
      parameters = function(value) {
        if (missing(value)) {
          StochasticPatch___FF16FvCB__parameters__get(self)
        } else {
          stop("StochasticPatch<FF16FvCB>$parameters is read-only")
        }
      },
      environment = function(value) {
        if (missing(value)) {
          StochasticPatch___FF16FvCB__environment__get(self)
        } else {
          stop("StochasticPatch<FF16FvCB>$environment is read-only")
        }
      },
      species = function(value) {
        if (missing(value)) {
          StochasticPatch___FF16FvCB__species__get(self)
        } else {
          stop("StochasticPatch<FF16FvCB>$species is read-only")
        }
      },
      ode_size = function(value) {
        if (missing(value)) {
          StochasticPatch___FF16FvCB__ode_size__get(self)
        } else {
          stop("StochasticPatch<FF16FvCB>$ode_size is read-only")
        }
      },
      ode_time = function(value) {
        if (missing(value)) {
          StochasticPatch___FF16FvCB__ode_time__get(self)
        } else {
          stop("StochasticPatch<FF16FvCB>$ode_time is read-only")
        }
      },
      ode_state = function(value) {
        if (missing(value)) {
          StochasticPatch___FF16FvCB__ode_state__get(self)
        } else {
          stop("StochasticPatch<FF16FvCB>$ode_state is read-only")
        }
      },
      ode_rates = function(value) {
        if (missing(value)) {
          StochasticPatch___FF16FvCB__ode_rates__get(self)
        } else {
          stop("StochasticPatch<FF16FvCB>$ode_rates is read-only")
        }
      }))

StochasticPatchRunner <- function(T) {
  type <- c(T)
  valid <- list("StochasticPatchRunner<FF16>"="FF16", "StochasticPatchRunner<FF16r>"="FF16r", "StochasticPatchRunner<FF16FvCB>"="FF16FvCB")
  constructors <- list("StochasticPatchRunner<FF16>"=`StochasticPatchRunner<FF16>`, "StochasticPatchRunner<FF16r>"=`StochasticPatchRunner<FF16r>`, "StochasticPatchRunner<FF16FvCB>"=`StochasticPatchRunner<FF16FvCB>`)
  constructors[[check_type(type, valid)]]
}
...
`StochasticPatchRunner<FF16FvCB>` <- function(parameters) {
  StochasticPatchRunner___FF16FvCB__ctor(parameters)
}
.R6_StochasticPatchRunner___FF16FvCB <-
  R6::R6Class(
    "StochasticPatchRunner<FF16FvCB>",
    inherit=.R6_StochasticPatchRunner,
    portable=TRUE,
    public=list(
      .ptr=NULL,
      ...
      run = function() {
        StochasticPatchRunner___FF16FvCB__run(self)
      },
      run_next = function() {
        StochasticPatchRunner___FF16FvCB__run_next(self)
      },
      reset = function() {
        StochasticPatchRunner___FF16FvCB__reset(self)
      },
      set_schedule_times = function(times) {
        StochasticPatchRunner___FF16FvCB__set_schedule_times(self, times)
      }),
    active=list(
      complete = function(value) {
        if (missing(value)) {
          StochasticPatchRunner___FF16FvCB__complete__get(self)
        } else {
          stop("StochasticPatchRunner<FF16FvCB>$complete is read-only")
        }
      },
      time = function(value) {
        if (missing(value)) {
          StochasticPatchRunner___FF16FvCB__time__get(self)
        } else {
          stop("StochasticPatchRunner<FF16FvCB>$time is read-only")
        }
      },
      parameters = function(value) {
        if (missing(value)) {
          StochasticPatchRunner___FF16FvCB__parameters__get(self)
        } else {
          stop("StochasticPatchRunner<FF16FvCB>$parameters is read-only")
        }
      },
      patch = function(value) {
        if (missing(value)) {
          StochasticPatchRunner___FF16FvCB__patch__get(self)
        } else {
          stop("StochasticPatchRunner<FF16FvCB>$patch is read-only")
        }
      },
      schedule = function(value) {
        if (missing(value)) {
          StochasticPatchRunner___FF16FvCB__schedule__get(self)
        } else {
          StochasticPatchRunner___FF16FvCB__schedule__set(self, value)
        }
      },
      state = function(value) {
        if (missing(value)) {
          StochasticPatchRunner___FF16FvCB__state__get(self)
        } else {
          stop("StochasticPatchRunner<FF16FvCB>$state is read-only")
        }
      }))
...
cohort_schedule_max_time_default <- function(p) {
  ...
  switch(cl,
         ...
         "Parameters<FF16FvCB>"=`cohort_schedule_max_time_default__Parameters___FF16FvCB`,
...
cohort_schedule_default <- function(p) {
  ...
  switch(cl,
         ...
         "Parameters<FF16FvCB>"=`cohort_schedule_default__Parameters___FF16FvCB`,
         stop("Unknown type: ", cl))(p)
}
...
make_cohort_schedule <- function(p) {
  ...
  switch(cl,
         ...
         "Parameters<FF16FvCB>"=`make_cohort_schedule__Parameters___FF16FvCB`,
         stop("Unknown type: ", cl))(p)
}
