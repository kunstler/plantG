...
template <> inline std::string   class_name_r<plant::Plant<plant::FF16FvCB_Strategy> >() {return "Plant<FF16FvCB>";}
template <> inline std::string   package_name<plant::Plant<plant::FF16FvCB_Strategy> >() {return "plant";}
template <> inline std::string generator_name<plant::Plant<plant::FF16FvCB_Strategy> >() {return ".R6_Plant___FF16FvCB";}
...
template <> inline std::string   class_name_r<plant::FF16FvCB_Strategy >() {return "FF16FvCB_Strategy";}
template <> inline std::string   package_name<plant::FF16FvCB_Strategy >() {return "plant";}
template <> inline std::string generator_name<plant::FF16FvCB_Strategy >() {return "";}
...
template <> inline std::string   class_name_r<plant::Parameters<plant::FF16FvCB_Strategy> >() {return "Parameters<FF16FvCB>";}
template <> inline std::string   package_name<plant::Parameters<plant::FF16FvCB_Strategy> >() {return "plant";}
template <> inline std::string generator_name<plant::Parameters<plant::FF16FvCB_Strategy> >() {return "";}
...
template <> inline std::string   class_name_r<plant::PlantPlus<plant::FF16FvCB_Strategy> >() {return "PlantPlus<FF16FvCB>";}
template <> inline std::string   package_name<plant::PlantPlus<plant::FF16FvCB_Strategy> >() {return "plant";}
template <> inline std::string generator_name<plant::PlantPlus<plant::FF16FvCB_Strategy> >() {return ".R6_PlantPlus___FF16FvCB";}
...
template <> inline std::string   class_name_r<plant::Cohort<plant::FF16FvCB_Strategy> >() {return "Cohort<FF16FvCB>";}
template <> inline std::string   package_name<plant::Cohort<plant::FF16FvCB_Strategy> >() {return "plant";}
template <> inline std::string generator_name<plant::Cohort<plant::FF16FvCB_Strategy> >() {return ".R6_Cohort___FF16FvCB";}
...
template <> inline std::string   class_name_r<plant::Species<plant::FF16FvCB_Strategy> >() {return "Species<FF16FvCB>";}
template <> inline std::string   package_name<plant::Species<plant::FF16FvCB_Strategy> >() {return "plant";}
template <> inline std::string generator_name<plant::Species<plant::FF16FvCB_Strategy> >() {return ".R6_Species___FF16FvCB";}
...
template <> inline std::string   class_name_r<plant::Patch<plant::FF16FvCB_Strategy> >() {return "Patch<FF16FvCB>";}
template <> inline std::string   package_name<plant::Patch<plant::FF16FvCB_Strategy> >() {return "plant";}
template <> inline std::string generator_name<plant::Patch<plant::FF16FvCB_Strategy> >() {return ".R6_Patch___FF16FvCB";}
...
template <> inline std::string   class_name_r<plant::SCM<plant::FF16FvCB_Strategy> >() {return "SCM<FF16FvCB>";}
template <> inline std::string   package_name<plant::SCM<plant::FF16FvCB_Strategy> >() {return "plant";}
template <> inline std::string generator_name<plant::SCM<plant::FF16FvCB_Strategy> >() {return ".R6_SCM___FF16FvCB";}
...
template <> inline std::string   class_name_r<plant::StochasticSpecies<plant::FF16FvCB_Strategy> >() {return "StochasticSpecies<FF16FvCB>";}
template <> inline std::string   package_name<plant::StochasticSpecies<plant::FF16FvCB_Strategy> >() {return "plant";}
template <> inline std::string generator_name<plant::StochasticSpecies<plant::FF16FvCB_Strategy> >() {return ".R6_StochasticSpecies___FF16FvCB";}
...
template <> inline std::string   class_name_r<plant::StochasticPatch<plant::FF16FvCB_Strategy> >() {return "StochasticPatch<FF16FvCB>";}
template <> inline std::string   package_name<plant::StochasticPatch<plant::FF16FvCB_Strategy> >() {return "plant";}
template <> inline std::string generator_name<plant::StochasticPatch<plant::FF16FvCB_Strategy> >() {return ".R6_StochasticPatch___FF16FvCB";}
...
template <> inline std::string   class_name_r<plant::StochasticPatchRunner<plant::FF16FvCB_Strategy> >() {return "StochasticPatchRunner<FF16FvCB>";}
template <> inline std::string   package_name<plant::StochasticPatchRunner<plant::FF16FvCB_Strategy> >() {return "plant";}
template <> inline std::string generator_name<plant::StochasticPatchRunner<plant::FF16FvCB_Strategy> >() {return ".R6_StochasticPatchRunner___FF16FvCB";}
=======
...
template <> inline SEXP wrap(const plant::Plant<plant::FF16FvCB_Strategy>& x) {
  return wrap(plant::RcppR6::RcppR6<plant::Plant<plant::FF16FvCB_Strategy> >(x));
}
template <> inline plant::Plant<plant::FF16FvCB_Strategy> as(SEXP x) {
  return *(plant::RcppR6::RcppR6<plant::Plant<plant::FF16FvCB_Strategy> >(x));
}
...
<<<<<<< HEAD
template <> inline SEXP wrap(const plant::FF16FvCB_Strategy& x) {
  Rcpp::List ret;
  ret["lma"] = Rcpp::wrap(x.lma);
  ret["rho"] = Rcpp::wrap(x.rho);
  ret["hmat"] = Rcpp::wrap(x.hmat);
  ...
  ret["a_dG2"] = Rcpp::wrap(x.a_dG2);
  ret["control"] = Rcpp::wrap(x.control);
  ret.attr("class") = "FF16FvCB_Strategy";
  return ret;
}
template <> inline plant::FF16FvCB_Strategy as(SEXP x) {
  if (!plant::RcppR6::is<plant::FF16FvCB_Strategy >(x)) {
    Rcpp::stop("Expected an object of type FF16FvCB_Strategy");
    // NOTE: Won't drop through or return anything.
  }
  // NOTE: assumes default constructable, and will assign *every*
  // field twice.  No current support for a hook.
  plant::FF16FvCB_Strategy ret;
  Rcpp::List xl(x);
  // ret.lma = Rcpp::as<decltype(retlma) >(xl["lma"]);
  ret.lma = Rcpp::as<double >(xl["lma"]);
  // ret.rho = Rcpp::as<decltype(retrho) >(xl["rho"]);
  ...
  // ret.a_p2 = Rcpp::as<decltype(reta_p2) >(xl["a_p2"]);
  ret.a_p2 = Rcpp::as<double >(xl["a_p2"]);
  // ret.a_p3 = Rcpp::as<decltype(reta_p3) >(xl["a_p3"]);
  ret.a_p3 = Rcpp::as<double >(xl["a_p3"]);
  // ret.a_f3 = Rcpp::as<decltype(reta_f3) >(xl["a_f3"]);
  ret.a_f3 = Rcpp::as<double >(xl["a_f3"]);
  // ret.a_f1 = Rcpp::as<decltype(reta_f1) >(xl["a_f1"]);
  ret.a_f1 = Rcpp::as<double >(xl["a_f1"]);
...
template <> inline SEXP wrap(const plant::Parameters<plant::FF16FvCB_Strategy>& x) {
  Rcpp::List ret;
  ret["k_I"] = Rcpp::wrap(x.k_I);
  ret["patch_area"] = Rcpp::wrap(x.patch_area);
  ret["n_patches"] = Rcpp::wrap(x.n_patches);
  ...
  ret.attr("class") = Rcpp::CharacterVector::create("Parameters<FF16FvCB>", "Parameters");
  return ret;
}
template <> inline plant::Parameters<plant::FF16FvCB_Strategy> as(SEXP x) {
  if (!plant::RcppR6::is<plant::Parameters<plant::FF16FvCB_Strategy> >(x)) {
    Rcpp::stop("Expected an object of type Parameters<FF16FvCB>");
    // NOTE: Won't drop through or return anything.
  }
  // NOTE: assumes default constructable, and will assign *every*
  // field twice.  No current support for a hook.
  plant::Parameters<plant::FF16FvCB_Strategy> ret;
  Rcpp::List xl(x);
  // ret.k_I = Rcpp::as<decltype(retk_I) >(xl["k_I"]);
  ret.k_I = Rcpp::as<double >(xl["k_I"]);
  // ret.patch_area = Rcpp::as<decltype(retpatch_area) >(xl["patch_area"]);
  ...
  ret.disturbance_mean_interval = Rcpp::as<double >(xl["disturbance_mean_interval"]);
  // ret.strategies = Rcpp::as<decltype(retstrategies) >(xl["strategies"]);
  ret.strategies = Rcpp::as<std::vector<plant::FF16FvCB_Strategy> >(xl["strategies"]);
  // ret.seed_rain = Rcpp::as<decltype(retseed_rain) >(xl["seed_rain"]);
  ret.seed_rain = Rcpp::as<std::vector<double> >(xl["seed_rain"]);
  // ret.is_resident = Rcpp::as<decltype(retis_resident) >(xl["is_resident"]);
  ret.is_resident = Rcpp::as<std::vector<bool> >(xl["is_resident"]);
  ...
  ret.control = Rcpp::as<plant::Control >(xl["control"]);
  // ret.strategy_default = Rcpp::as<decltype(retstrategy_default) >(xl["strategy_default"]);
  ret.strategy_default = Rcpp::as<plant::FF16FvCB_Strategy >(xl["strategy_default"]);
  // ret.cohort_schedule_max_time = Rcpp::as<decltype(retcohort_schedule_max_time) >(xl["cohort_schedule_max_time"]);
  ret.cohort_schedule_max_time = Rcpp::as<double >(xl["cohort_schedule_max_time"]);
  // ret.cohort_schedule_times_default = Rcpp::as<decltype(retcohort_schedule_times_default) >(xl["cohort_schedule_times_default"]);
  ret.cohort_schedule_times_default = Rcpp::as<std::vector<double> >(xl["cohort_schedule_times_default"]);
...
template <> inline SEXP wrap(const plant::PlantPlus<plant::FF16FvCB_Strategy>& x) {
  return wrap(plant::RcppR6::RcppR6<plant::PlantPlus<plant::FF16FvCB_Strategy> >(x));
}
template <> inline plant::PlantPlus<plant::FF16FvCB_Strategy> as(SEXP x) {
  return *(plant::RcppR6::RcppR6<plant::PlantPlus<plant::FF16FvCB_Strategy> >(x));
}
...
template <> inline SEXP wrap(const plant::Cohort<plant::FF16FvCB_Strategy>& x) {
  return wrap(plant::RcppR6::RcppR6<plant::Cohort<plant::FF16FvCB_Strategy> >(x));
}
template <> inline plant::Cohort<plant::FF16FvCB_Strategy> as(SEXP x) {
  return *(plant::RcppR6::RcppR6<plant::Cohort<plant::FF16FvCB_Strategy> >(x));
}
...
template <> inline SEXP wrap(const plant::Species<plant::FF16FvCB_Strategy>& x) {
  return wrap(plant::RcppR6::RcppR6<plant::Species<plant::FF16FvCB_Strategy> >(x));
}
template <> inline plant::Species<plant::FF16FvCB_Strategy> as(SEXP x) {
  return *(plant::RcppR6::RcppR6<plant::Species<plant::FF16FvCB_Strategy> >(x));
}
...
template <> inline SEXP wrap(const plant::Patch<plant::FF16FvCB_Strategy>& x) {
  return wrap(plant::RcppR6::RcppR6<plant::Patch<plant::FF16FvCB_Strategy> >(x));
}
template <> inline plant::Patch<plant::FF16FvCB_Strategy> as(SEXP x) {
  return *(plant::RcppR6::RcppR6<plant::Patch<plant::FF16FvCB_Strategy> >(x));
}
...
template <> inline SEXP wrap(const plant::SCM<plant::FF16FvCB_Strategy>& x) {
  return wrap(plant::RcppR6::RcppR6<plant::SCM<plant::FF16FvCB_Strategy> >(x));
}
template <> inline plant::SCM<plant::FF16FvCB_Strategy> as(SEXP x) {
  return *(plant::RcppR6::RcppR6<plant::SCM<plant::FF16FvCB_Strategy> >(x));
}
...
template <> inline SEXP wrap(const plant::StochasticSpecies<plant::FF16FvCB_Strategy>& x) {
  return wrap(plant::RcppR6::RcppR6<plant::StochasticSpecies<plant::FF16FvCB_Strategy> >(x));
}
template <> inline plant::StochasticSpecies<plant::FF16FvCB_Strategy> as(SEXP x) {
  return *(plant::RcppR6::RcppR6<plant::StochasticSpecies<plant::FF16FvCB_Strategy> >(x));
}
...
template <> inline SEXP wrap(const plant::StochasticPatch<plant::FF16FvCB_Strategy>& x) {
  return wrap(plant::RcppR6::RcppR6<plant::StochasticPatch<plant::FF16FvCB_Strategy> >(x));
}
template <> inline plant::StochasticPatch<plant::FF16FvCB_Strategy> as(SEXP x) {
  return *(plant::RcppR6::RcppR6<plant::StochasticPatch<plant::FF16FvCB_Strategy> >(x));
}
...
template <> inline SEXP wrap(const plant::StochasticPatchRunner<plant::FF16FvCB_Strategy>& x) {
  return wrap(plant::RcppR6::RcppR6<plant::StochasticPatchRunner<plant::FF16FvCB_Strategy> >(x));
}
template <> inline plant::StochasticPatchRunner<plant::FF16FvCB_Strategy> as(SEXP x) {
  return *(plant::RcppR6::RcppR6<plant::StochasticPatchRunner<plant::FF16FvCB_Strategy> >(x));
}
}
