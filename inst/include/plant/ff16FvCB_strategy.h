// -*-c++-*-
#ifndef PLANT_PLANT_FF16FvCB_STRATEGY_H_
#define PLANT_PLANT_FF16FvCB_STRATEGY_H_
...
struct FF16FvCB_Strategy {
public:
  typedef std::shared_ptr<FF16FvCB_Strategy> ptr;
  FF16FvCB_Strategy();
  ...
  // Set constants within FF16FvCB_Strategy
